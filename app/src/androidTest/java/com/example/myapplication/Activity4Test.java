...
public class Activity4Test {
    ...
    public ActivityTestRule<Activity4> activityActivityTestRule4 = new ActivityTestRule<>(Activity4.class);
    @Test
    ...
    public void intentTest(){
        ...
        intending(toPackage("com.example.myapplication.Activity5")).respondWith(result);
        onView(withId(R.id.button)).perform(click());
        onView(withId(R.id.next1)).perform(click());
        onView(withId(R.id.next2)).perform(click());
        onView(withId(R.id.next3)).perform(click());
